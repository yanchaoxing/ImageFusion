...
%
% https://www.vlfeat.org/matconvnet/install/    - install matconvnet
% https://www.vlfeat.org/matconvnet/pretrained/ - imagenet-vgg-verydeep-19.mat
%
...
function img = run_DLF(imgVI, imgIR, visualization)
    ...
    addpath(genpath('D:\tools\matconvnet\matlab'));
    vl_setupnn ;

    %load vgg19
    net = load('imagenet-vgg-verydeep-19.mat'); % > 500MB
